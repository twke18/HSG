...
class ResnetFcn(ResnetBase):
  ...
  def _calculate_kmeans_prototypes(self,
    ...
    _, num_clusters_per_image = torch.unique(
        unique_batch_and_cluster_indices // self.label_divisor,
        return_counts=True)
    max_num_clusters = num_clusters_per_image.max()
...
class MultiviewResnetFcn(ResnetFcn):
  ...
  def _calculate_kmeans_prototypes(self,
    ...
    _, num_clusters_per_image = torch.unique(
        unique_image_and_cluster_indices // self.label_divisor,
        return_counts=True)
    max_num_clusters = num_clusters_per_image.max()
