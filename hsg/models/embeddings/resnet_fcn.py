...
def resnet_101_fcn_test(config):
  """FCN with resnet101 backbone.
  """
  return ResnetFcn([3, 4, 23, 3], [1, 2, 1, 1], [1, 1, 2, 4], config)


def resnet_50_fcn_test(config):
  """FCN with resnet50 backbone.
  """
  return ResnetFcn([3, 4, 6, 3], [1, 2, 1, 1], [1, 1, 2, 4], config)
