...
config.train.fine_hrchy_loss_types = 'none'
config.train.coarse_hrchy_loss_types = 'none'
config.train.centroid_cont_loss_types = 'none'
config.train.dmon_loss_types = 'none'
...
config.train.fine_hrchy_concentration = 0
config.train.coarse_hrchy_concentration = 0
config.train.centroid_cont_concentration = 0
...
config.train.fine_hrchy_loss_weight = 0.0
config.train.coarse_hrchy_loss_weight = 0.0
config.train.centroid_cont_loss_weight = 0.0
config.train.dmon_loss_weight = 0.0
config.train.fine_hrchy_clusters = 9
config.train.coarse_hrchy_clusters = 4
config.train.dmon_knn = 2
